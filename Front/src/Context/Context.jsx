...
export const BotonProvider = ({ children }) => {
    ...
    const url = "https://junction.proxy.rlwy.net:33337/api"; // endpoint general de api back end
    ...
    const fetchUsers = async () => {
        try {
            const response = await fetch('https://junction.proxy.rlwy.net:33337/api/users', {
                method: 'GET',
                headers: {
                  'Content-Type': 'application/json',
