  ...
  const confirmarReserva = async () => {
    if (horaSeleccionada && fechaSeleccionada && direction.trim() !== "") {
      try {
        ...
        const responseCartId = await axios.get(`https://ctdintegradorequipo1-production.up.railway.app/api/carts/user/${loggedUser.id}`);
        ...
        const responseCart = await fetch(`https://ctdintegradorequipo1-production.up.railway.app/api/carts/${cartId}/items`, settings);
        ...
        const responseOrder = await fetch('https://ctdintegradorequipo1-production.up.railway.app/api/orders/create', settingsOrder);
