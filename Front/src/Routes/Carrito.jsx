  ...
  const confirmarReserva = async () => {
    if (horaSeleccionada && fechaSeleccionada && direction.trim() !== "") {
      try {
        ...
        const responseCartId = await axios.get(`https://junction.proxy.rlwy.net:33337/api/carts/user/${loggedUser.id}`);
        ...
        const responseCart = await fetch(`https://junction.proxy.rlwy.net:33337/api/carts/${cartId}/items`, settings);
        ...
        const responseOrder = await fetch('https://junction.proxy.rlwy.net:33337/api/orders/create', settingsOrder);
